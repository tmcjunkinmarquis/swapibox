...
import { getHomeWorld, getSpecies, getPlanetDetails, getVehicleDetails } from '../../api/helper';
  ...
  render() {
    return (
      <div className="App">
        ...
        <div>
          {this.state.cardType && <CardContainer className="card-container" allState={this.state} />}
        </div>
      </div>
    );
  }
